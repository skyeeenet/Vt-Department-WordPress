...
function vtdep_scripts() {
    ...
    wp_enqueue_style( 'vtdep-fancybox', 'https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css' );
    ...
    wp_enqueue_script('schedule-1', get_template_directory_uri() . '/assets/js/schedule.js', array(),null, true);
    wp_enqueue_script('test-menu', get_template_directory_uri() . '/assets/js/test.js', array(),null, true);
