<?php
/**
 * VTDEPARTMENT functions and definitions
 *
...
if ( ! function_exists( 'vtdep_setup' ) ) :
	...
	function vtdep_setup() {
		 ...
		 * If you're building a theme based on VTDEPARTMENT, use a find and replace
		 * to change 'vtdep' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'vtdep', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'vtdep_custom_background_args', array(
